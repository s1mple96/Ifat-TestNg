...
class CreateBrand extends DubboRequest{
    {
        super.interfaceName = "com.platform.goods.proxy.api.BrandMgrService"  //接口路径
        super.methodName="createBrand"
        super.version="1.0"
        super.group="on"
        super.timeOut=10000
        super.paramsType=["com.platform.goods.proxy.vo.request.GoodBrandDetailVO"] //请求参数
        super.params = [["name","icon","remark","createBy"]]
    }
